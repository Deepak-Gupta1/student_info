  ...
  <div class="table-responsive-sm">
           <table class='table table-bordered mt-4 ' style='border-color: #131314;'>
                <thead class='table-warning '>
                  <tr>
                    <th scope="col bordered-black">Student Nmae</th>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td><a class="nav-link" href="indiviual.php?stdname=<?php echo  $row["name"]; ?>" ><?php echo  $row["name"]; ?></a></td>
                   ...
                   <tbody> 
                    ...
                    echo " <tr>
                    <td colspan='4'>No newspapers Available Now. Visit After some time.</td>
                </tr>";
                }
                ?>
            </table>
